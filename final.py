...
def get_sentiment_label(sentiment_scores, text):
    ...
    negative_keywords = [
        ...
        "vulnerable", "weak", "worthless","not happy", "is not joy", "don't love", "not excited", "great", "not wonderful", 
        "not the best day", "not fantastic", "not awesome","not amazing", "not brilliant", "not cheerful", "not delightful", 
        "not elated", "not encouraged", "not enthusiastic","not excellent", "not fabulous", "not fantastic", "not flawless", 
        "not fortunate", "not free", "not glad", "not gleeful","not good", "not happy", "not healthy", "not helpful", "not ideal", 
        "not impeccable", "not incredible", "not kind","not lucky", "not marvelous", "not nice", "not optimistic", "not perfect", 
        "not pleased", "not positive", "not proud","not radiant", "not satisfied", "not smiling", "not stunning", "not superb", 
        "not thankful", "not triumphant","not victorious", "not winning", "not wonderful", "not zealous"
    ]
    positive_keywords = [
